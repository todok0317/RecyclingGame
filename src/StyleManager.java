...
public class StyleManager {
	...
	public static Font fontMidiumRegular = new Font("한컴 말랑말랑 Regular", Font.PLAIN, 20);
	public static Font fontSmallRegular = new Font("한컴 말랑말랑 Regular", Font.PLAIN, 14);
