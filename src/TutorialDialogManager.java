...
public class TutorialDialogManager {
    ...
    public TutorialDialogManager(GameFrame gameFrame, GameView gameView) {
    ...
    private void showLevelDialog(String level) {
        ...
        // 메시지 레이블
        JLabel messageLabel = new JLabel("<html><div style='text-align: center;'>" + dialogMessage.replaceAll("\r\n", "<br>") + "</div></html>");
